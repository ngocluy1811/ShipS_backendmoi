...
function initSocket(server) {
  io = new Server(server, {
    cors: {
      origin: ['http://localhost:5173', 'http://localhost:5174', 'https://ships-admin.onrender.com', 'https://ships-customermoi.onrender.com', 'https://ships-backendmoihehe-1.onrender.com'],
